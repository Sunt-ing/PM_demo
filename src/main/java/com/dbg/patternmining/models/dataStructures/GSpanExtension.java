...
public class GSpanExtension<NodeType, EdgeType> implements
	 ...
	 */
	@Override
	public Frequency frequency(Integer i) {
		return getFragment().frequency(i);
	}
	
	public Frequency upperBound(Integer i) {
		return getFragment().upperBound(i);
	}
	
	public Frequency oneEdgeUpperBound(Integer i) {
		return getFragment().oneEdgeUpperBound(i);
	}
	
	public Frequency aftUBFrequency(Integer i) {
		return getFragment().aftUBFrequency(i);
	}
